                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Edit Lokasi Instansi</h6>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal style-form" action="editaksi_instansi.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                                    <div class="mb-3"> 
                                        <label for="exampleFormControlInput1" class="form-label">ID Intansi</label>
                                        <div class="mb-3">
                                            <input name="id_instansi" type="text" id="id_instansi" class="form-control" value="<?php echo $data[
                                                'id_instansi'
                                            ]; ?>" readonly />
                                    ...
                                    <label for="exampleFormControlInput1" class="form-label">Nama Instansi</label>
                                        <div class="mb-3">
                                            <input name="nama_instansi" type="text" id="nama_instansi" class="form-control" value="<?php echo $data[
                                                'nama_instansi'
                                            ]; ?>" required />
                                        </div>
                                    </div>
