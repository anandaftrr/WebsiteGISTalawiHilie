                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Edit Lokasi Rumah Ibadah</h6>
                        </div>
                        <div class="card-body">
                            ...
                            $query = mysqli_query(
                                $koneksi,
                                "select * from masjid where id_masjid='$id'"
                            );
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal style-form" action="editaksi_masjid.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                                    <div class="mb-3"> 
                                        <label for="exampleFormControlInput1" class="form-label">ID Masjid</label>
                                        <div class="mb-3">
                                            <input name="id_masjid" type="text" id="id_masjid" class="form-control" value="<?php echo $data[
                                                'id_masjid'
                                            ]; ?>" readonly />
                                    ...
                                    <label for="exampleFormControlInput1" class="form-label">Nama Rumah Ibadah</label>
                                        <div class="mb-3">
                                            <input name="nama_masjid" type="text" id="nama_masjid" class="form-control" value="<?php echo $data[
                                                'nama_masjid'
                                            ]; ?>" required />
                                        </div>
                                    </div>
